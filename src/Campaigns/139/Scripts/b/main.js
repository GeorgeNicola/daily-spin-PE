...
var richConfig = {
  ...
  claimPrize(claimidentifier, prizeName) {
    if (typeof buildRForLocal !== "undefined") { // this parameter exist in the Mockdata folder only for local
...
var spinConfig = {
  ...
  openPopup: function (selectedPopup, popupDescription) {
